...
*/
static int demoDirectWrite(DemoFile* p,       /* File handle */
...
** Open a file handle.
*/
static int demoOpen(sqlite3_vfs* pVfs,   /* VFS */
...
*/
static int demoAccess(sqlite3_vfs* pVfs, const char* zPath, int flags, int* pResOut)
{
...
*/
static int demoFullPathname(sqlite3_vfs* pVfs, /* VFS */
